  ...
  <div class="container">
    ...
    <div class="news-grid" id="newsGrid">
      ...
      <article class="news-card" data-category="ekspansi">
        <a href="index.php?page=article&slug=jasa-pengiriman-surabaya-jakarta" class="news-card-link">
      ...
      <article class="news-card" data-category="promosi">
        <a href="index.php?page=article&slug=tarif-ekspedisi-surabaya-jakarta" class="news-card-link">
          <div class="news-image">
      ...
      <article class="news-card" data-category="update">
        <a href="index.php?page=article&slug=layanan-logistik-aman-surabaya-jakarta" class="news-card-link">
          <div class="news-image">
